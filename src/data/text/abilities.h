...
static const u8 sStenchDescription[] = _("May poison targets.");
...
static const u8 sSturdyDescription[] = _("Survives at full HP.");
...
static const u8 sLightningRodDescription[] = _("Absorbs ELECTRIC moves; raises SP. ATK.");
...
static const u8 sIlluminateDescription[] = _("Raises encounters; lowers foes' ACC.");
...
static const u8 sMagmaArmorDescription[] = _("Prevents freezing; halves WATER damage.");
static const u8 sWaterVeilDescription[] = _("Prevents burns; Water moves heal.");
static const u8 sMagnetPullDescription[] = _("Traps STEEL; lowers SP. DEF.");
static const u8 sSoundproofDescription[] = _("Blocks sound; raises SP. ATK.");
...
static const u8 sEarlyBirdDescription[] = _("Waking sharply raises a stat.");
...
static const u8 sKeenEyeDescription[] = _("No ACC loss; ignores EVASION; boosts aim.");
...
static const u8 sTruantDescription[] = _("Status moves work while loafing.");
...
static const u8 sPlusDescription[] = _("ELECTRIC moves may burn.");
static const u8 sMinusDescription[] = _("ELECTRIC moves may freeze.");
static const u8 sForecastDescription[] = _("Changes with the weather.");
static const u8 sStickyHoldDescription[] = _("Prevents theft; slows contact.");
...
static const u8 sLiquidOozeDescription[] = _("Draining hurts and poisons.");
