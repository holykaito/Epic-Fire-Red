...
BattleScript_MagnetPullLowersSpDef::
	setstatchanger STAT_SPDEF, 1, TRUE
	statbuffchange STAT_CHANGE_ALLOW_PTR | STAT_CHANGE_NOT_PROTECT_AFFECTED, BattleScript_MagnetPullLowersSpDefEnd
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG

BattleScript_MagnetPullLowersSpDefEnd::
	end2
...
BattleScript_IlluminateActivationAnimLoop::
	trygetintimidatetarget BattleScript_IlluminateEnd
	...
	jumpifability BS_TARGET, ABILITY_KEEN_EYE, BattleScript_IlluminateAbilityFail
...
BattleScript_LightningRodActivates::
	...
	waitmessage B_WAIT_TIME_LONG
	jumpifstat BS_TARGET, CMP_EQUAL, STAT_SPATK, MAX_STAT_STAGE, BattleScript_LightningRodEnd
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_LightningRodEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_LightningRodEnd
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
